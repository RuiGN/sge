...
urlpatterns = [
    ...
    path('https://relfsrecife.pythonanywhere.com/api/v1/brands/', views.BrandCreateListAPIView.as_view(), name='brand-create-list-api-view'),
    path('https://relfsrecife.pythonanywhere.com/api/v1/brands/<int:pk>/', views.BrandRetrieveUpdateDestroyAPIView.as_view(), name='brand-detail-api-view'),
]
